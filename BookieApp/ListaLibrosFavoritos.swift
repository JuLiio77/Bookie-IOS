            ...
            Section {
                ...
                ScrollView(.vertical) {
                    ...
                    LazyVGrid(columns: columnas) {
                        ...
                        ForEach(librosFavoritos.librosFav) { book in
                            
                            NavigationLink(destination: DetalleLibroBibliotecaView(book: book, bookmodelFav: BookModelFavoritos(id: "", isFavorite: true))) {
