...
class Peticiones {
    ...
    // FUNCION POST DE LOGIN DE USUARIO -- SE LE MANDA POR PARAMETRO EL USERNAME Y LA CONTRASEÑA Y SI ESTA CORRECTO NOS DEVUELVE UN TOKEN
...
//    }
    ...
    // revisar funcion porque se han cambiado cosas del modelo y la forma de hacerlo
